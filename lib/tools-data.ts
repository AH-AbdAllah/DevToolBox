...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: "CSV / JSON Converter & Grid",
    description: "Convert CSV to JSON or JSON to CSV with a live editable table preview and text filter search.",
    category: "converters",
    href: "/tools/csv-json-converter",
    icon: "Shuffle",
    keywords: ["csv", "json", "converter", "table preview", "csv to json", "json to csv", "grid"],
    isFeatured: true,
    isPopular: true,
  },
  {
    id: "tailwind-playground",
    name: "Tailwind CSS Layout Designer",
    description: "Visually design Flexbox and Grid layouts, configure alignment classes, and copy clean markup.",
    category: "developers",
    href: "/tools/tailwind-playground",
    icon: "Palette",
    keywords: ["tailwind", "css", "flexbox", "grid", "playground", "layout", "visual builder"],
    isFeatured: true,
    isPopular: true,
  },
  {
    ...
    description: "Private local key pair generation and text encryption using symmetric/asymmetric browser API.",
    category: "encoders",
    href: "/tools/crypto-sandbox",
    icon: "Key",
    keywords: ["cryptography", "encryption", "rsa", "aes", "gcm", "key pair", "keygen", "secure"],
    isFeatured: true,
    isPopular: true,
  },
  {
    ...
    description: "Calculate network address ranges, broadcast endpoints, host limits, netmasks, and binary divisions.",
    category: "converters",
    href: "/tools/subnet-calculator",
    icon: "Binary",
    keywords: ["ip", "subnet", "cidr", "calculator", "network", "netmask", "wildcard"],
    isFeatured: true,
    isPopular: true,
  },
  {
    ...
    description: "Compare text drafts or JSON logs side-by-side with highlighted line insertions and deletions.",
    category: "developers",
    href: "/tools/diff-checker",
    icon: "Terminal",
    keywords: ["diff", "compare", "visual diff", "text compare", "lines diff", "side by side"],
    isFeatured: true,
    isPopular: true,
  },
